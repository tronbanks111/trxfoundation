...
contract TronBanks {
    ...
    uint public club1 = 50*sunny; // 50000
    uint public club2 = 200*sunny; // 200000
   ...
   function updateBigPlayer() private {
     ...
     function reinvest() public payable {
      ...
      if(member2.isClub2 == 0 && member2.isClub1 == 1){
        ...
        } else if(member2.isClub2 == 0 && msg.value >= club2){

           club2MembersCount ++;
            member2.isClub2 = 1;

           } else if(member2.isClub1 == 0 && msg.value >= club1){
            club1MembersCount ++;
            member2.isClub1 = 1;
