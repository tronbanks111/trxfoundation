...
contract TronBanks {
    ...
    uint private hourRate = 124; //DAILY 3%
    uint private noOfHours = 2400;  
    uint private ultraBiz = 10000000*sunny; //10000000
    uint private ultraElg = 4000000*sunny; //4000000
    uint private ultraMaxCount = 10;
    ...
    constructor() public {
       ...
       member.totalInvested = 100000*sunny;
       ...
       dep.depositValue = 100000*sunny;
       dep.cumDeposit = 100000*sunny;
  ...
  if(members[_refAddr5].totalBiz >= ultraBiz && ultraCount < ultraMaxCount){
    ...
    function withdraw(uint256 _trx) public payable{
